...
if is_dark:
    ...
    <style>
        ...
        /* Main Content Questions Radio Options in Light Theme */
        .main div[data-testid="stRadio"],
        .main div[data-testid="stRadio"] *,
        .main div[data-testid="stRadioButton"],
        .main div[data-testid="stRadioButton"] *,
        section.main div[data-testid="stRadio"],
        section.main div[data-testid="stRadio"] *,
        section.main div[data-testid="stRadioButton"],
        section.main div[data-testid="stRadioButton"] *,
        ...
        .main div[data-testid="stRadioButton"] label,
        section.main div[data-testid="stRadio"] label,
        section.main div[data-testid="stRadioButton"] label {
            background-color: #ffffff !important;
            border: 1.5px solid #cbd5e1 !important;
            border-radius: 12px !important;
        ...
        .main div[data-testid="stRadioButton"] label:hover,
        section.main div[data-testid="stRadio"] label:hover,
        section.main div[data-testid="stRadioButton"] label:hover {
        ...
        .main div[data-testid="stRadioButton"] label p,
        .main div[data-testid="stRadioButton"] label span,
        .main div[data-testid="stRadioButton"] label div,
        ...
        section.main div[data-testid="stRadioButton"] label p,
        section.main div[data-testid="stRadioButton"] label span,
        section.main div[data-testid="stRadioButton"] label div {
            color: #0f172a !important;
            font-size: 1.05rem !important;
            font-weight: 600 !important;
            opacity: 1 !important;
